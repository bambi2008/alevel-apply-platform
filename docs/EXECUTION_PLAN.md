...
Completed — all four core entry pages use the interview page's minimal visual system and release `b5ec778` is healthy on Beta while production remains on `367b7e2`.
