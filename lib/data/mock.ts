...
export const mockPrograms: Program[] = [
  ...
  { id: "cam-eco", universityId: "cam", name: "Economics", nameZh: "经济学", degreeType: "BA", applyRoute: "UCAS", annualTuitionGbp: 40000, alevelOfferTypical: "A*A*A", alevelOfferMinimum: "A*AA", requiredSubjects: [M("Mathematics")], ielts: 7.5, ieltsSubscores: { listening: 7.0, reading: 7.0, writing: 7.0, speaking: 7.0 }, admissionsTest: "ECAA", interviewRequired: true },
  ...
  { id: "lse-eco", universityId: "lse", name: "Economics", nameZh: "经济学", degreeType: "BSc", applyRoute: "UCAS", annualTuitionGbp: 38000, alevelOfferTypical: "A*AA", alevelOfferMinimum: "AAA", requiredSubjects: [M("Mathematics", "A")], ielts: 7.0, ieltsSubscores: { listening: 6.5, reading: 6.5, writing: 6.5, speaking: 6.5 } },
