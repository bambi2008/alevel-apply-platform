...
export const MAT_PART_A_EXTRA: MCQQuestion[] = [
  ...
  },
  {
    ...
    difficulty: 3,
    marks: 4,
    question: "If $\\alpha$ and $\\beta$ are roots of $x^2 - 3x + 1 = 0$, what is $\\alpha^4 + \\beta^4$?",
    options: [
      { key: "A", text: "$31$" },
      { key: "B", text: "$45$" },
      { key: "C", text: "$47$" },
    ...
    answer: "C",
    solution: "$\\alpha+\\beta=3$ and $\\alpha\\beta=1$, so $\\alpha^2+\\beta^2=3^2-2=7$. Hence $\\alpha^4+\\beta^4=(\\alpha^2+\\beta^2)^2-2\\alpha^2\\beta^2=49-2=47$.",
  },
  {
    id: "mat-a-049",
    type: "mcq",
