...
export const ESAT_CHALLENGE: MCQQuestion[] = [
  // ── 数学挑战 ──
  { id: "esat-ch-m01", type: "mcq", testId: "esat", topicId: "esat-math1", difficulty: 3, marks: 1,
    question: "The polynomial $x^3-3x+2$ has a repeated root. What is it?",
    options: [ {key:"A",text:"$-2$"},{key:"B",text:"$2$"},{key:"C",text:"$1$"},{key:"D",text:"$-1$"} ],
    answer: "C", solution: "$x^3-3x+2=(x-1)^2(x+2)$, so the repeated root is $x=1$." },
  { id: "esat-ch-m02", type: "mcq", testId: "esat", topicId: "esat-math1", difficulty: 3, marks: 1,
    question: "What is the remainder when $x^{100}$ is divided by $(x+1)$?",
    options: [ {key:"A",text:"$-1$"},{key:"B",text:"$1$"},{key:"C",text:"$100$"},{key:"D",text:"$0$"} ],
    answer: "B", solution: "By the remainder theorem the remainder is $(-1)^{100}=1$." },
  { id: "esat-ch-m03", type: "mcq", testId: "esat", topicId: "esat-math2", difficulty: 3, marks: 1,
    question: "What is the area enclosed between $y=x$ and $y=x^2$ from $x=0$ to $x=1$?",
    options: [ {key:"A",text:"$\\tfrac12$"},{key:"B",text:"$\\tfrac13$"},{key:"C",text:"$\\tfrac{1}{12}$"},{key:"D",text:"$\\tfrac16$"} ],
    answer: "D", solution: "$\\int_0^1 (x-x^2)\\,dx=\\tfrac12-\\tfrac13=\\tfrac16$." },
  { id: "esat-ch-m04", type: "mcq", testId: "esat", topicId: "esat-math3", difficulty: 3, marks: 1,
    question: "What is the sum to infinity of $1+\\tfrac13+\\tfrac19+\\cdots$?",
    options: [ {key:"A",text:"$\\tfrac32$"},{key:"B",text:"$2$"},{key:"C",text:"$1$"},{key:"D",text:"$3$"} ],
    answer: "A", solution: "Geometric with $r=\\tfrac13$: sum $=\\dfrac{1}{1-\\tfrac13}=\\tfrac32$." },
  { id: "esat-ch-m05", type: "mcq", testId: "esat", topicId: "esat-math2a", difficulty: 3, marks: 1,
    question: "If $z=1+i$, what is $z^4$?",
    options: [ {key:"A",text:"$4$"},{key:"B",text:"$4i$"},{key:"C",text:"$-4$"},{key:"D",text:"$-4i$"} ],
    answer: "C", solution: "$z^2=(1+i)^2=2i$, so $z^4=(2i)^2=-4$." },
  { id: "esat-ch-m06", type: "mcq", testId: "esat", topicId: "esat-math2b", difficulty: 3, marks: 1,
    question: "What is the determinant of $\\begin{pmatrix}2&1\\\\4&3\\end{pmatrix}$?",
    options: [ {key:"A",text:"$6$"},{key:"B",text:"$2$"},{key:"C",text:"$10$"},{key:"D",text:"$-2$"} ],
    answer: "B", solution: "$\\det=2\\cdot3-1\\cdot4=2$." },

  // ── 物理挑战 ──
  { id: "esat-ch-p01", type: "mcq", testId: "esat", topicId: "esat-phys1", difficulty: 3, marks: 1,
    question: "A $2\\,\\text{kg}$ object accelerates at $3\\,\\text{m s}^{-2}$. What is the net force on it?",
    options: [ {key:"A",text:"$3\\,\\text{N}$"},{key:"B",text:"$6\\,\\text{N}$"},{key:"C",text:"$1.5\\,\\text{N}$"},{key:"D",text:"$5\\,\\text{N}$"} ],
    answer: "B", solution: "$F=ma=2\\times3=6\\,\\text{N}$." },
  { id: "esat-ch-p02", type: "mcq", testId: "esat", topicId: "esat-phys1", difficulty: 3, marks: 1,
    question: "An object falls freely from rest for $3\\,\\text{s}$ (take $g=10\\,\\text{m s}^{-2}$). What is its speed?",
    options: [ {key:"A",text:"$30\\,\\text{m s}^{-1}$"},{key:"B",text:"$15\\,\\text{m s}^{-1}$"},{key:"C",text:"$10\\,\\text{m s}^{-1}$"},{key:"D",text:"$45\\,\\text{m s}^{-1}$"} ],
    answer: "A", solution: "$v=gt=10\\times3=30\\,\\text{m s}^{-1}$." },
  { id: "esat-ch-p03", type: "mcq", testId: "esat", topicId: "esat-phys2", difficulty: 3, marks: 1,
    question: "A $4\\,\\Omega$ resistor carries a current of $3\\,\\text{A}$. What power is dissipated?",
    options: [ {key:"A",text:"$12\\,\\text{W}$"},{key:"B",text:"$7\\,\\text{W}$"},{key:"C",text:"$36\\,\\text{W}$"},{key:"D",text:"$48\\,\\text{W}$"} ],
    answer: "C", solution: "$P=I^2R=3^2\\times4=36\\,\\text{W}$." },
  { id: "esat-ch-p04", type: "mcq", testId: "esat", topicId: "esat-phys2", difficulty: 3, marks: 1,
    question: "Two $6\\,\\Omega$ resistors are connected in parallel. What is their combined resistance?",
    options: [ {key:"A",text:"$12\\,\\Omega$"},{key:"B",text:"$6\\,\\Omega$"},{key:"C",text:"$2\\,\\Omega$"},{key:"D",text:"$3\\,\\Omega$"} ],
    answer: "D", solution: "$\\tfrac1R=\\tfrac16+\\tfrac16=\\tfrac13$, so $R=3\\,\\Omega$." },
  { id: "esat-ch-p05", type: "mcq", testId: "esat", topicId: "esat-phys3", difficulty: 3, marks: 1,
    question: "A wave has frequency $50\\,\\text{Hz}$ and wavelength $4\\,\\text{m}$. What is its speed?",
    options: [ {key:"A",text:"$200\\,\\text{m s}^{-1}$"},{key:"B",text:"$54\\,\\text{m s}^{-1}$"},{key:"C",text:"$12.5\\,\\text{m s}^{-1}$"},{key:"D",text:"$100\\,\\text{m s}^{-1}$"} ],
    answer: "A", solution: "$v=f\\lambda=50\\times4=200\\,\\text{m s}^{-1}$." },
  { id: "esat-ch-p06", type: "mcq", testId: "esat", topicId: "esat-phys3", difficulty: 3, marks: 1,
    question: "A photon's energy is $E=hf$. If its frequency doubles, its energy:",
    options: [ {key:"A",text:"halves"},{key:"B",text:"doubles"},{key:"C",text:"is unchanged"},{key:"D",text:"quadruples"} ],
    answer: "B", solution: "$E\\propto f$, so doubling $f$ doubles $E$." },

  // ── 化学挑战 ──
  { id: "esat-ch-c01", type: "mcq", testId: "esat", topicId: "esat-chem1", difficulty: 3, marks: 1,
    question: "How many electrons are in a neutral atom of oxygen (atomic number $8$)?",
    options: [ {key:"A",text:"$16$"},{key:"B",text:"$6$"},{key:"C",text:"$8$"},{key:"D",text:"$2$"},{key:"E",text:"$10$"} ],
    answer: "C", solution: "A neutral atom has electrons equal to its atomic number: $8$." },
  { id: "esat-ch-c02", type: "mcq", testId: "esat", topicId: "esat-chem1", difficulty: 3, marks: 1,
    question: "What type of bond holds Na and Cl together in sodium chloride?",
    options: [ {key:"A",text:"ionic"},{key:"B",text:"covalent"},{key:"C",text:"metallic"},{key:"D",text:"hydrogen"},{key:"E",text:"dative"} ],
    answer: "A", solution: "Na donates an electron to Cl, forming oppositely charged ions held by ionic bonding." },
  { id: "esat-ch-c03", type: "mcq", testId: "esat", topicId: "esat-chem2", difficulty: 3, marks: 1,
    question: "What is the general formula of an alkane?",
    options: [ {key:"A",text:"$C_nH_{2n}$"},{key:"B",text:"$C_nH_{2n-2}$"},{key:"C",text:"$C_nH_n$"},{key:"D",text:"$C_nH_{2n+2}$"},{key:"E",text:"$C_nH_{2n+1}$"} ],
    answer: "D", solution: "Alkanes are saturated hydrocarbons with formula $C_nH_{2n+2}$." },
  { id: "esat-ch-c04", type: "mcq", testId: "esat", topicId: "esat-chem2", difficulty: 3, marks: 1,
    question: "Which functional group is present in ethanol?",
    options: [ {key:"A",text:"carboxyl"},{key:"B",text:"hydroxyl"},{key:"C",text:"carbonyl"},{key:"D",text:"amino"},{key:"E",text:"ester"} ],
    answer: "B", solution: "Ethanol ($CH_3CH_2OH$) contains the hydroxyl $(-OH)$ group." },
  { id: "esat-ch-c05", type: "mcq", testId: "esat", topicId: "esat-chem3", difficulty: 3, marks: 1,
    question: "For an exothermic reaction, the enthalpy change $\\Delta H$ is:",
    options: [ {key:"A",text:"negative"},{key:"B",text:"positive"},{key:"C",text:"zero"},{key:"D",text:"always $1$"},{key:"E",text:"undefined"} ],
    answer: "A", solution: "Exothermic reactions release heat, so $\\Delta H<0$ (negative)." },
  { id: "esat-ch-c06", type: "mcq", testId: "esat", topicId: "esat-chem3", difficulty: 3, marks: 1,
    question: "What is the pH of a neutral aqueous solution at $25^\\circ\\text{C}$?",
    options: [ {key:"A",text:"$0$"},{key:"B",text:"$14$"},{key:"C",text:"$7$"},{key:"D",text:"$1$"},{key:"E",text:"$10$"} ],
    answer: "C", solution: "At $25^\\circ\\text{C}$ a neutral solution has pH $7$." },

  // ── 生物挑战 ──
  { id: "esat-ch-b01", type: "mcq", testId: "esat", topicId: "esat-bio1", difficulty: 3, marks: 1,
    question: "Which organelle is the main site of aerobic respiration?",
    options: [ {key:"A",text:"nucleus"},{key:"B",text:"mitochondrion"},{key:"C",text:"ribosome"},{key:"D",text:"chloroplast"},{key:"E",text:"Golgi apparatus"} ],
    answer: "B", solution: "Aerobic respiration (the Krebs cycle and oxidative phosphorylation) occurs in the mitochondrion." },
  { id: "esat-ch-b02", type: "mcq", testId: "esat", topicId: "esat-bio1", difficulty: 3, marks: 1,
    question: "In DNA, which base pairs with adenine?",
    options: [ {key:"A",text:"thymine"},{key:"B",text:"guanine"},{key:"C",text:"cytosine"},{key:"D",text:"uracil"},{key:"E",text:"adenine"} ],
    answer: "A", solution: "In DNA, adenine pairs with thymine (A–T)." },
  { id: "esat-ch-b03", type: "mcq", testId: "esat", topicId: "esat-bio2", difficulty: 3, marks: 1,
    question: "A cross between two heterozygotes ($Aa\\times Aa$) gives what ratio of dominant to recessive phenotypes?",
    options: [ {key:"A",text:"$1:1$"},{key:"B",text:"$9:3:3:1$"},{key:"C",text:"$1:2:1$"},{key:"D",text:"$3:1$"},{key:"E",text:"$2:1$"} ],
    answer: "D", solution: "$Aa\\times Aa$ gives genotypes $1\\,AA:2\\,Aa:1\\,aa$, i.e. $3$ dominant : $1$ recessive." },
  { id: "esat-ch-b04", type: "mcq", testId: "esat", topicId: "esat-bio2", difficulty: 3, marks: 1,
    question: "Natural selection acts most directly on an organism's:",
    options: [ {key:"A",text:"phenotype"},{key:"B",text:"genotype"},{key:"C",text:"DNA sequence"},{key:"D",text:"ribosomes"},{key:"E",text:"individual alleles"} ],
    answer: "A", solution: "Selection acts on the phenotype (observable traits); allele frequencies change as a consequence." },
  { id: "esat-ch-b05", type: "mcq", testId: "esat", topicId: "esat-bio3", difficulty: 3, marks: 1,
    question: "Which structure is the main site of gas exchange in the human lungs?",
    options: [ {key:"A",text:"bronchi"},{key:"B",text:"trachea"},{key:"C",text:"alveoli"},{key:"D",text:"diaphragm"},{key:"E",text:"larynx"} ],
    answer: "C", solution: "Gas exchange occurs across the thin walls of the alveoli." },
  { id: "esat-ch-b06", type: "mcq", testId: "esat", topicId: "esat-bio3", difficulty: 3, marks: 1,
    question: "In a food chain, organisms that make their own food are called:",
    options: [ {key:"A",text:"producers"},{key:"B",text:"consumers"},{key:"C",text:"decomposers"},{key:"D",text:"predators"},{key:"E",text:"herbivores"} ],
    answer: "A", solution: "Producers (e.g. plants) synthesise their own food by photosynthesis." },
];

export const ESAT_QUESTIONS = [...ESAT_MATH, ...ESAT_MATH_2, ...ESAT_PHYSICS, ...ESAT_PHYSICS_2, ...ESAT_MATH2A, ...ESAT_MATH2B, ...ESAT_CHEM, ...ESAT_BIO_QUESTIONS, ...ESAT_TOPUP_QUESTIONS, ...ESAT_CHALLENGE, ...ESAT_HARD_QUESTIONS];
